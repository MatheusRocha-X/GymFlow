...
export default function CreateRoutineModal({ onClose, onComplete, routineId }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center" onClick={onClose}>
      <div
        className="bg-card w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-2xl sm:rounded-2xl flex flex-col"
        ...
        >
          ...
          >
            <div className="p-4 border-b border-border">
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-bold">Selecionar Exercício</h3>
              ...
              {filteredExercises?.map((exercise) => (
                ...
                >
                  ...
                  <div className="flex gap-2 mt-1">
                    <Badge className={getMuscleColor(exercise.primaryMuscle)} style={{ fontSize: '10px' }}>
                      {exercise.primaryMuscle}
                    </Badge>
